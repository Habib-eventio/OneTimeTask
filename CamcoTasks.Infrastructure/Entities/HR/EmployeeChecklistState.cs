...
[Table("HR_EmployeeChecklistStates")]
public class EmployeeChecklistState
{
    [Key]
    ...
    [Column("ChecklistItemId", TypeName = "smallint")]
    public short ChecklistItemId { get; set; }

    [Column("SignOffDate", TypeName = "datetime")]
