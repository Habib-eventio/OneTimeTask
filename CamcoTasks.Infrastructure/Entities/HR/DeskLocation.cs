...
public class DeskLocation
{
    ...
    [Column("DeskLocationCode", TypeName = "nvarchar(255)")]
    [StringLength(255)]
    [MaxLength(255)]
    [Required]
    public string DeskLocationCode { get; set; }

    [Column("DeskLocationDescription", TypeName = "nvarchar(255)")]
    [StringLength(255)]
    [MaxLength(255)]
    public string DeskLocationDescription { get; set; }
