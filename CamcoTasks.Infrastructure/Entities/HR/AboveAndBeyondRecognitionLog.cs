...
[Table("HR_AboveAndBeyondRecognitionLogs")]
public class AboveAndBeyondRecognitionLog
{
    [Key]
    ...
    [Column("AboveAndBeyondRecognitionId", TypeName = "bigint")]
    public long AboveAndBeyondRecognitionId { get; set; }
