...
public class JobDescription
{
    ...
    [Column("RecommendedTierLevelId", TypeName = "bigint")]
    public long? RecommendedTierLevelId { get; set; }

    [Column("JobTitleTypeId", TypeName = "smallint")]
    public short? JobTitleTypeId { get; set; }

    [Column("JobDescriptionTypeId", TypeName = "smallint")]
    public short? JobDescriptionTypeId { get; set; }
