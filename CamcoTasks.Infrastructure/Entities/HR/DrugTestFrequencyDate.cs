...
[Table("HR_DrugTestFrequencyDates")]
public class DrugTestFrequencyDate
{
    ...
    [Column("NextTestDate", TypeName = "datetime2(7)")]
    ...
    [Column("TestDone", TypeName = "bit")] public bool TestDone { get; set; }

    [Column("DrugTestResultId", TypeName = "bigint")]
    public long? DrugTestResultId { get; set; }
}